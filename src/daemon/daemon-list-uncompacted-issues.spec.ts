...
describe('daemonListUncompactedIssues', () => {
  ...
  it('should resolve with response on success', async () => {
    ...
    const mockClient = {
      listUncompactedIssues: vi.fn((_req, _options, callback) => {
    ...
    const result = await daemonListUncompactedIssues({})
  ...
  it('should reject with error on failure', async () => {
    ...
    await expect(daemonListUncompactedIssues({})).rejects.toThrow('gRPC error')
  })
})
